...
export default function Home() {
  ...
  const [company] = useState("instagram");
              ...
              {messages.length === 0 && (
                <div className="text-center py-20">
                  ...
                  <p className="text-slate-500 dark:text-slate-400 max-w-lg mx-auto mb-8 leading-relaxed">
                    Start asking questions about your data. I&apos;ll help you discover insights and provide intelligent answers. ✨
                  </p>
                  {/* Upload CTA removed */}
                </div>
              )}
